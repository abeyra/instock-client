      ...
      <>
        ...
        <div className="card__tablet">
          <div className="warehouse__info">
            ...
            <Link to={`/editwarehouse/${this.state.chosenWarehouse.id}`}>
              <span className="warehouse__info--edit-wrap">
                <img src={Edit} />
              </span>
            </Link>
            <Link to={`/editwarehouse/${this.state.chosenWarehouse.id}`}>
              <span className="warehouse__info--edit-wrap--big">
                <img src={Edit} /> Edit
              </span>
            </Link>
          </div>
        ...
        <section className="warehouse__container">
          ...
          <section className="warehouse__container--contact">
            ...
            <div>
              <h4 className="warehouse__container--header">
                CONTACT INFORMATION:
              </h4>
        ...
        <section>
          <div className="field">
            <div className="field__section">
              <h4 className="field__name">Inventory item</h4>
              <img className="field__icon" src={Sort} alt="Sort icon." />
            </div>
            <div className="field__section">
              <h4 className="field__name">Category</h4>
              <img className="field__icon" src={Sort} alt="Sort icon." />
            </div>
            <div className="field__section">
              <h4 className="field__name">Status</h4>
              <img className="field__icon" src={Sort} alt="Sort icon." />
            </div>
            <div className="field__section">
              <h4 className="field__name">QTY</h4>
              <img className="field__icon" src={Sort} alt="Sort icon." />
            </div>
            <h4 className="field__name field__name--action">Action</h4>
          </div>
        </section>
        <section>
              ...
              <section className="inventory__container">
                <div className="inventory__container--top">
                  <div className="inventory__container--item">
                    <p className="inventory__container--item--heading">
                      INVENTORY ITEM
                    </p>
                    <p className="inventory__container--item--name">
                      {item.itemName} <img src={ArrowRight} />
                    </p>
                  </div>
                ...
                <section>
                  <div className="inventory__container--icons">
                    ...
                    <Link
                      to={`/editwarehouse/${this.state.chosenWarehouse.id}`}
                    >
                      <img src={Edit} />
                    </Link>
                  </div>
